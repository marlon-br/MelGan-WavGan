...
class Hparams:
    ...
    data_dir = '/content/drive/My Drive/audio/melgan-audio' # Путь к звуковым файлам для тренировки
    test_dir = '/content/drive/My Drive/audio/newvoice/audiofiles/21' # Папка куда надо поместить файлы для тестирования    
